...
app.layout = html.Div([
    ...
    html.H1("Automobile Sales Statistics Dashboard", style=title_style),#May include style for title
...
# Plot 4 bar chart for the effect of unemployment rate on vehicle type and sales
        unemp_rec = recession_data.groupby(['Year', 'Vehicle_Type'])['Unemployment_Rate'].mean().reset_index()
        R_chart4 = dcc.Graph(
        figure=px.bar(
            unemp_rec,
            x='Year',
        ...
        return [
            html.Div(className='chart-item', children=[html.Div(children=R_chart1),html.Div(children=R_chart2)],style={'display': 'flex', 'justify-content': 'space-between'}),
            html.Div(className='chart-item', children=[html.Div(children=R_chart3),html.Div(children=R_chart4)],style={'display': 'flex', 'justify-content': 'space-between'})
            ]
...
# Plot 2 Total Monthly Automobile sales using line chart.
        Y_chart2 = dcc.Graph(figure=px.line(monthly_sales, x='Year', y='Automobile_Sales', title="Total Monthly Automobile Sales"))
